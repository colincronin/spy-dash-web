...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('spy_blogger', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('notes', self.gf('django.db.models.fields.TextField')(blank=True, null=True)),
        ))
        db.send_create_signal('spy', ['Blogger'])

        # Adding model 'Post'
        db.create_table('spy_post', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('blogger', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spy.Blogger'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(blank=True, auto_now_add=True)),
        ))
        db.send_create_signal('spy', ['Post'])


    def backwards(self, orm):
        # Deleting model 'Blogger'
        db.delete_table('spy_blogger')

        # Deleting model 'Post'
        db.delete_table('spy_post')
    ...
    models = {
        ...
        'spy.post': {
            ...
            'blogger': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['spy.Blogger']"}),
